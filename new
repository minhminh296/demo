    ...
    <style>
        * {
        ...
        body {
            margin: 0;
            padding: 0;
            background: linear-gradient(135deg, #349edb);
            overflow: hidden;
        ...
        .center-message {
            ...
            background: linear-gradient(135deg, rgba(255, 255, 255, 0.95), rgba(30, 136, 229, 0.85));
            padding: 40px 50px;
            border-radius: 30px;
            font-size: 1.6rem;
            font-weight: 400;
        ...
        .center-message strong {
            ...
            margin-bottom: 15px;
            font-weight: 700;
           background: linear-gradient(45deg, #00c6ff, #7b2ff7, #f441a5);
        ...
        .popup {
            ...
            background: linear-gradient(135deg, #0ed3d3 0%, #e4e6ee 100%);
            border-radius: 25px;
            box-shadow: 0 25px 80px rgba(206, 188, 195, 0.4);
            padding: 30px;
            text-align: center;
            z-index: 100;
            width: 90%;
...
<body>
    ...
    <div class="center-message">
        ...
        <span id="centerText">
            ...
            Mong mẹ và chị luôn rạng rỡ như những bó hoa!
        </span>
    </div>
    ...
    <script>
        ...
        const messages = [
            {
                img: "./assets/a1.jfif", //Thay ảnh
                text: "Chúc mẹ và chị luôn vui vẻ, xinh đẹp và ngập tràn yêu thương!" //Thay lời nhắn
            },
            {
                img: "./assets/a2.jfif",
                text: "Mỗi ngày của mẹ và chị đều là một đoá hoa nở rộ."
            },
            {
                img: "./assets/a3.jfif",
                text: "Cảm ơn mẹ và chị vì đã luôn mạnh mẽ và tuyệt vời như thế!"
            },
            {
                img: "./assets/a4.jfif",
                text: "Chúc mẹ và chị một ngày 20/10 thật hạnh phúc và trọn vẹn! "
            },
            {
                img: "./assets/a5.jpg",
                text: "Mẹ và chị là món quà tuyệt vời nhất mà cuộc sống mang lại! "
            }
        ];
